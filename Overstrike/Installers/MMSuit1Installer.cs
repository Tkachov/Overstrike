...
namespace Overstrike.Installers {
	internal class MMSuit1Installer: SuitInstallerBase {
		public static readonly Dictionary<string, byte> LANGUAGES = new() {
			...
			/*
			LANGUAGE_CA_FRENCH	CANADIAN FRENCH
			LANGUAGE_INDONESIAN	INDONESIAN
			LANGUAGE_MX_SPANISH	MEXICAN SPANISH
		...
		public MMSuit1Installer(TOC_I20 toc, string gamePath, string language = "") : base(toc, gamePath) {
		...
		private void WriteBase1(string suitsPath, string id, bool writeName) {
			...
			// Suits & UnlockForFree
			var suit = "SUIT_" + id;
			var nameKey = (writeName ? ("SUIT_" + id.ToUpper()) : "SUIT_MILES_2020");
