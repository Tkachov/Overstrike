...
namespace Overstrike.Installers {
	internal class MSMRSuitInstaller: SuitInstallerBase {
		public MSMRSuitInstaller(TOC_I20 toc, string gamePath) : base(toc, gamePath) {} // TODO: setting to install or ignore name.txt
		...
		private void AddToSuitsList(Config config, string suit, string rewardRef, string iconRef, string equipRef) {
			...
			suitObject["DisplayName"] = "CHARWEB_MAY"; // TODO: support name.txt
			suitObject["Description"] = "CHARWEB_MAY";
