...
namespace Overstrike.Games {
	internal class GameMSMR: GameBase {
		...
		public override string BannerBackgroundResourceKey => "banner_msmr_back.png";

		public override string BannerLogoLeftResourceKey => "banner_msmr_logo.png";

		public override string BannerLogoRightResourceKey => "banner_msmr_logo2.png";
