...
namespace Overstrike.Games {
	internal class GameMSM2: GameBase {
		...
		private static Dictionary<string, string> _knownHashes = new () {
			...
			{ "83889B7130622EDDE7CF91AF9F4497BB097A644B", "v1.401.1.0" },
			{ "3878D890FC7D86E0651F1594D4C093C8AB9E40AF", "v1.408.0.0" },
			{ "2325F4D0816BA351E7F6E50D760505EA88D2D72D", "v1.508.0.0" },
			{ "C59325C9B03A1F20F946FD950D12998A9138CEB2", "v1.520.0.0" },
			{ "6829BC78E277997D21483975545E0A27F7C0191A", "v1.526.0.0" }, // same as v2.629.0.0
			{ "CEB3E7823F4981873A6E34B211B14F0E0200D461", "v2.727.0.0" },
			{ "D18940B7DED9CF83B6E7AB57BBD0FA43F5FD5290", "v2.810.0.0" },
		};
		...
		public override BitmapImage BannerBackground => GetThemedImage("banner_msm2_back.png"); // shared background image

		public override BitmapImage BannerLogoLeft => GetThemedImage("banner_msm2_logo.png");

		public override BitmapImage BannerLogoRight => GetThemedImage("banner_msm2_logo2.png");
