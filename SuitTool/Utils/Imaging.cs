...
namespace SuitTool.Utils {
	internal static class Imaging { // copy of Overstrike.utils.Imaging, just for the sake of not getting OverstrikeShared dependent on BCnEncoder
		#region dds
